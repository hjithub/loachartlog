"""
One-off: fully paginate categories 60000, 100000, 230000 and report which
items are alive (have real yesterday-price data) vs dead (YDayAvgPrice=0,
never actually traded) so we can decide what's worth adding to
fetch_movers.py's CATEGORIES list. Temporary — deleted after use.

Usage:
  LOSTARK_API_KEY=... python3 scripts/probe_new_categories.py
"""
...
CANDIDATES = [60000, 100000, 230000]
MAX_PAGES = 30
